...
<body>
    ...
    <div class="form-container">
        ...
        <div class="field-container">
            <label for="cardnumber">Номер карты</label><span id="generatecard">Сгенерировать номер</span>
        ...
        <div class="field-container">
            <label for="expirationdate">MM/YY</label>
    ...
    <div class="payment-title">
        <form class="payment" action="{{ route('index') }}">
            <button>
                Оплатить
            </button>
        </form>
